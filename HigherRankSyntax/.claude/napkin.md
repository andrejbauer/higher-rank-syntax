...
1. **[2026-08-31] Semantic categories use quotients, not Setoid enrichment**
...
2. **[2026-08-08] Distinguish ordinary and protected-prefix lifting**
...
3. **[2026-08-03] Prove telescope-tensor coherence through base extension**
...
4. **[2026-08-03] Use HEq at dependent telescope-tensor projections**
...
5. **[2026-08-03] Telescope reindexing uses a specialized pushforward**
...
6. **[2026-06-23] Carrier product slots need cover**
   Do instead: use `Carrier.cover` to split arbitrary `Γ ⋈ Δ` slots; `classify_inl`/`classify_inr` only handle injected slots.
7. **[2026-08-03] Extract decorated prefixes through precedence factorization**
