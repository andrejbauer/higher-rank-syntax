...
postcomposition as
\[
  \sigma \mathbin{\triangleright} \kappa :
  S \leadsto ((P \bowtie D') \bowtie T) \bowtie S'.
\]
It is defined pointwise by
\[
  (\sigma \mathbin{\triangleright} \kappa)(x)
  =
...
\[
\boxed{
  (\sigma \mathbin{\triangleright} \kappa)_U
  \bigl(
...
postcomposition \(\sigma \mathbin{\triangleright} \kappa\).  The right-hand
...
The postcomposition \(\sigma \mathbin{\triangleright} \kappa\) is precisely the
...
\[
  L_j =
  (\sigma \mathbin{\triangleright} \kappa)_{U \ext \arity(j)}
  \bigl(
...
\[
  L_j = R_j
\]
for every binder argument \(j\).  Therefore the under case concludes by
...
and then the postcomposition \(\sigma \mathbin{\triangleright} \kappa\) fires.
The two results are equal because \(\sigma \mathbin{\triangleright} \kappa\)
...
\[
  ...
  \bigr).
\]
The recursive hypothesis again gives \(L_j = R_j\) for every \(j\).  Therefore
...
\[
  ...
  \bigr).
\]
The induction hypothesis gives \(L_j = R_j\), and hence
\[
